...
import 'package:fscreen/widgets/alarm_widgets/paused_widget/paused_alarm_screen.dart';
...
class PausedServerMainScreen extends StatefulWidget {
  //final int movieId;
  PausedServerMainScreen({
    Key? key,
    // required this.movieId,
  }) : super(key: key);

  @override
  State<PausedServerMainScreen> createState() => _PausedServerMainScreenState();
}

class _PausedServerMainScreenState extends State<PausedServerMainScreen> {
  @override
